...
_L2:
    ...
    protected void onMeasure(int i, int j)
    {
        ...
        k2 = android.view.View.MeasureSpec.getSize(i);
        i3 = android.view.View.MeasureSpec.getMode(j);
...
_L1:
        ...
        f = 0.0F;
        flag = false;
        j1 = k2 - getPaddingLeft() - getPaddingRight();
        l2 = getChildCount();
        if (l2 > 2)
        {
        ...
        k1 = 0;
_L8:
        if (k1 >= l2) goto _L5; else goto _L4
_L4:
        View view;
        LayoutParams layoutparams;
        view = getChildAt(k1);
        layoutparams = (LayoutParams)view.getLayoutParams();
        if (view.getVisibility() != 8) goto _L7; else goto _L6
_L6:
        int l;
        int i2;
        boolean flag1;
...
_L7:
        float f1 = f;
        if (layoutparams.weight <= 0.0F) goto _L10; else goto _L9
_L9:
        ...
        f = f1;
        i2 = j1;
        if (layoutparams.width == 0) goto _L11; else goto _L10
_L10:
        i = layoutparams.leftMargin + layoutparams.rightMargin;
        if (layoutparams.width == -2)
        {
            i = android.view.View.MeasureSpec.makeMeasureSpec(k2 - i, 0x80000000);
        } else
        if (layoutparams.width == -1)
        {
            i = android.view.View.MeasureSpec.makeMeasureSpec(k2 - i, 0x40000000);
        } else
        {
        ...
        if (flag || f > 0.0F)
        {
            ...
            while (i1 < l2) 
            {
                ...
                if (view1.getVisibility() != 8)
                {
                    ...
                    {
                        if (layoutparams1.width < 0 && (l1 > j2 || layoutparams1.weight > 0.0F))
                        {
                            if (i != 0)
                            {
                            ...
                            view1.measure(android.view.View.MeasureSpec.makeMeasureSpec(j2, 0x40000000), i);
                        }
                    } else
                    if (layoutparams1.weight > 0.0F)
                    {
                        ...
                        if (flag)
                        {
                            int j3 = k2 - (layoutparams1.leftMargin + layoutparams1.rightMargin);
                            int l3 = android.view.View.MeasureSpec.makeMeasureSpec(j3, 0x40000000);
                            if (l1 != j3)
                            {
                                view1.measure(l3, i);
                            }
                        ...
                        {
                            int k3 = Math.max(0, j1);
                            view1.measure(android.view.View.MeasureSpec.makeMeasureSpec(l1 + (int)((layoutparams1.weight * (float)k3) / f), 0x40000000), i);
                        }
                    }
                }
                i1++;
