...
_L9:
        ...
        f4 = (float)getPaddingLeft() / (float)getClientWidth();
        l = mCurItem - 1;
...
_L11:
        if (f2 < (2.0F - f3) + f4 || l >= l1) goto _L14; else goto _L13
_L13:
        if (iteminfo2 != null) goto _L15; else goto _L12
_L12:
        f2 = iteminfo1.widthFactor;
        l = k + 1;
        if (f2 >= 2.0F) goto _L17; else goto _L16
_L16:
        float f;
        if (l < mItems.size())
        {
        ...
        f3 = (float)getPaddingRight() / (float)getClientWidth();
        j = mCurItem + 1;
        iteminfo2 = ((ItemInfo) (obj));
_L23:
